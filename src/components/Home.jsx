...
// // import pic from '../assets/Hammad.jpg';
...
//     return (
//         <>
//             <div name='Home' className='max-w-screen-2xl mx-auto container px-4 md:px-20 py-20 dark:bg-gray-900 dark:text-white'>
            ...
            <div name='Home' className='max-w-screen-2xl mx-auto container px-4 md:px-20 py-20 dark:bg-gray-900 dark:text-white'>
                <div className='flex flex-col md:flex-row'>
                    ...
                    <div data-aos="fade-right" className='md:w-1/2 mt-12 md:mt-24 space-y-2 order-2 md:order-1'>
                        ...
                        <p className='text-sm md:text-xl text-justify'>
                            My name is Hammad Liaquat, and I am a MERN Stack Developer with a background in BSc Computer Science. I build dynamic and scalable web applications using MongoDB, Express.js, React.js, and Node.js.
                        </p>
                        ...
                        <div className="flex space-x-4 pt-4">
                            {/* <a
                                ...
                                download
                                className="bg-red-600 text-white px-5 py-2 rounded-lg hover:bg-red-700 duration-200"
                            >
                                Download Resume
                            </a> */}
                        ...
                        {/* SOCIAL MEDIA */}
                        <div className="flex flex-col items-center md:flex-row justify-between space-y-6 md:space-y-0 pt-6">
